...
sort_me = selection_sort(sort_me)
print("Sorted List:", sort_me)
...
sort_me2 = insertion_sort(sort_me2)
print("Sorted List:", sort_me2)
...
sort_me3 = selection_sort(sort_me3)
print("Sorted List:", sort_me3)
